    ...
    <form action="" method="post">
        ...
        <tr>
         ...
         <tr>
            ...
            <td><input type="checkbox" name="catatan_khusus01" value="Kehadiran >=70%" >Kehadiran >=70%<br>
            <input type="checkbox" name="catatan_khusus02" value="Interaktif dikelas">Interaktif dikelas<br>
            <input type="checkbox" name="catatan_khusus03" value="Tidak terlambat mengumpulkan tugas">Tidak terlambat mengumpulkan tugas
            </td>
